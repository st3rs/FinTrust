            ...
            <div className="p-8 sm:p-10 space-y-12">
              ...
              <section className="space-y-6 pt-6 border-t border-slate-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  {/* Crypto */}
                  <label className={`relative border rounded-xl p-4 flex gap-3 cursor-pointer transition-colors ${
                    paymentMethods.crypto ? 'border-orange-500 bg-orange-50/30' : 'border-slate-200 hover:bg-slate-50'
                  }`}>
                    <input
                      type="checkbox"
                      className="w-4 h-4 mt-1 border-slate-300 rounded text-orange-500 focus:ring-orange-500"
                      checked={paymentMethods.crypto}
                      onChange={e => setPaymentMethods({...paymentMethods, crypto: e.target.checked})}
                    />
                    <div>
                      <div className="font-semibold text-slate-900 text-sm flex items-center gap-1.5 mb-1">
                        <Bitcoin className="w-4 h-4 text-orange-500" /> Cryptocurrency
                      </div>
                      <div className="text-xs text-slate-500">USDT, BTC, ETH, BNB</div>
                    </div>
                    {paymentMethods.crypto && (
                      <div className="absolute top-0 right-0 w-0 h-0 border-t-[28px] border-t-orange-500 border-l-[28px] border-l-transparent rounded-tr-xl">
                        <svg className="absolute -top-[24px] right-1 w-3 h-3 text-white stroke-[4]" viewBox="0 0 24 24" fill="none" stroke="currentColor"><polyline points="20 6 9 17 4 12"></polyline></svg>
                      </div>
                    )}
                  </label>
